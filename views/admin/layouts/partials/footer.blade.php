<footer class="footer app-footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
        ...
        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href="https://contentpress.news" target="_blank">ContentPress</a> v{{cp_get_app_version()}}</span>
    </div>
</footer>
