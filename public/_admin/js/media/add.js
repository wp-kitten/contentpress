...
/***/ "./resources/js/admin/_scripts/media/add.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/_scripts/media/add.js ***!
  \**************************************************/
...
jQuery(function ($) {
  ...
  var previewWrapper = $('.js-image-preview-uploads');

  var __dropBgItem = $('.backdrop-preview');
          ...
          if (r) {
            if (r.success) {
              if (r.data) {
                ...
                showToast(pageLocale.text_image_set, 'success'); //#! Clear the preview of the uploaded image

                var dropify = $('#media_image_upload_field').dropify();
...
/***/ 18:
/*!********************************************************!*\
  !*** multi ./resources/js/admin/_scripts/media/add.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\www\contentpress\resources\js\admin\_scripts\media\add.js */"./resources/js/admin/_scripts/media/add.js");
